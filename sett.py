token = 'Aqui una palabra o token para la verificacion'

whatsapp_token = 'Ingresa aqui el token'

whatsapp_url = 'Ingresa aqui el graph de fb'

# Stickers que ya venian por si se quieren utilizar
